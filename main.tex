...
\addbibresource{arcticles/01-o-patrimonio-da-comp/references.bib}
\addbibresource{arcticles/02-farinha-e-carne-no-s/references.bib}
\addbibresource{arcticles/03-nao-ao-peso-nao-ao-r/references.bib}
...
\include{arcticles/01-o-patrimonio-da-comp/main}
\include{arcticles/02-farinha-e-carne-no-s/main}
\include{arcticles/03-nao-ao-peso-nao-ao-r/main}
